...
const checks = [
  ...
  [engagements, 'The sovereign command infrastructure through which a government logistics institution coordinates', 'government identity'],
  [engagements, 'ports, freight, customs, suppliers, and public authorities', 'logistics scope'],
  [engagements, 'Govern passage across borders', 'global mobility record'],
  [engagements, 'entire visa IP—policy, eligibility, documentation, pricing, payment, and fulfillment—transformed into agentic systems', 'visa scope'],
  ...
  [engagements, 'A sovereign intelligence estate spanning matters, precedent, clients, communications, and commercial knowledge', 'legal scope'],
  [engagements, 'privilege and professional duty', 'legal controls'],
  [engagements, 'Keep frontier intelligence inside the institution', 'private intelligence record'],
  [engagements, 'Frontier models, retrieval architectures, and governed data infrastructure', 'private model scope'],
  ...
  [engagements, 'The operating fabric of a major developer—from land and construction through inventory, agents, commercial assets, and sales', 'real-estate scope'],
  [engagements, 'Where scale exceeds human attention', 'scale chapter'],
  [engagements, 'Make capital answer to strategy', 'capital record'],
  [engagements, 'forecasts, obligations, capital allocation, and executive judgment are reconciled', 'capital scope'],
...
for (const retiredPhrase of [
  ...
  'Built for a government logistics institution',
  'Built the infrastructure for visa discovery',
  'Built a governed intelligence system',
  'Built private models and data infrastructure',
  'Built the operating system through which a major developer',
